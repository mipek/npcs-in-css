...
#ifndef CE_SIMTIMER_H
#define CE_SIMTIMER_H
...
class CE_CSimTimer : public CE_CSimpleSimTimer
{
public:
	CE_CSimTimer( float interval = 0.0, bool startExpired = true )	
	{ 
...
class CE_CRandSimTimer : public CE_CSimpleSimTimer
{
public:
	CE_CRandSimTimer( float minInterval = 0.0, float maxInterval = 0.0, bool startExpired = true )	
	{ 
...
class CE_CStopwatchBase  : public CE_CSimpleSimTimer
{
public:
	CE_CStopwatchBase()	
	{ 
	...
	bool Expired() const
	{
		return ( m_fIsRunning && CE_CSimpleSimTimer::Expired() );
	}
...
//-------------------------------------
class CE_CSimpleStopwatch  : public CE_CStopwatchBase
{
public:
	void Start( float minCountdown, float maxCountdown = 0.0 )
	{ 
		m_fIsRunning = true;
		CE_CSimpleSimTimer::Set( minCountdown, maxCountdown );
	}
...
class CE_CStopwatch : public CE_CStopwatchBase
{
public:
	CE_CStopwatch ( float interval = 0.0 )
	{ 
		Set( interval );
	}
...
class CE_CRandStopwatch : public CE_CStopwatchBase
{
public:
	CE_CRandStopwatch( float minInterval = 0.0, float maxInterval = 0.0 )	
	{ 
...
class CE_CThinkOnceSemaphore
{
public:
	CE_CThinkOnceSemaphore()
	 :	m_lastTime( -1 )
	{
	}
