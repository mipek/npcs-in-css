...
//=========================================================
class CHLMachineGun : public CCombatWeapon
{
public:
	CE_DECLARE_CLASS( CHLMachineGun, CCombatWeapon );
	DECLARE_DATADESC();
	...
	// utility function
	static void DoMachineGunKick( CPlayer *pPlayer, float dampEasy, float maxVerticleKickAngle, float fireDurationTime, float slideLimitTime );

	// server sided muzzle flash (CEntity)
	void CE_MuzzleFlash(float scale = 1.0f, int type = MUZZLEFLASH_TYPE_DEFAULT);
...
{
	CE_DECLARE_CLASS( CHLSelectFireMachineGun, CHLMachineGun );
public:
