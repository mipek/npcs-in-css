...
class CAI_PoliceGoal : public CE_InfoTarget_Fix
{
public:

	CE_DECLARE_CLASS( CAI_PoliceGoal, CE_InfoTarget_Fix );
	...
	void		KnockOutTarget( CEntity *pTarget );									// Send an output that we've knocked out this target
