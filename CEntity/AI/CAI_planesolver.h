...
public:
	...
	void AddObstacle( const Vector &pos, float radius, CEntity *pEntity = NULL, AI_MoveSuggType_t type = AIMST_AVOID_OBJECT );
...
private:
	...
	float AdjustRegulationWeight( CEntity *pEntity, float weight );
