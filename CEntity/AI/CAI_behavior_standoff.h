...
#ifndef _INCLUDE_CAI_BEHAVIOR_STANDOFF_H
#define _INCLUDE_CAI_BEHAVIOR_STANDOFF_H
...
protected:
	...
	virtual void OnChangeActiveWeapon( CCombatWeapon *pOldWeapon, CCombatWeapon *pNewWeapon );
...
#endif // _INCLUDE_CAI_BEHAVIOR_STANDOFF_H