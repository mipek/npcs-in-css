...
// Purpose:
//-----------------------------------------------------------------------------
class CPropJeep : public CE_CPropVehicleDriveable_Fix
{
public:
	CE_DECLARE_CLASS( CPropJeep, CE_CPropVehicleDriveable_Fix );
	...
	virtual bool	AllowBlockedExit( CBaseEntity *pPlayer, int nRole ) { return false; }
...
protected:
	...
	CFakeHandle		m_hLastPlayerInVehicle;
	CFakeHandle		m_hSeagull;
	bool			m_bHasPoop;
