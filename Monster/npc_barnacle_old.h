...
//-----------------------------------------------------------------------------
class CBarnacleTongueTip : public CNPCBaseInteractive<CAnimating>
{
	CE_DECLARE_CLASS( CBarnacleTongueTip, CAnimating );
...
private:
	...
	CEFakeHandle<CEntity>		m_hLastSpitEnemy;
	int							m_nShakeCount;
	...
	float						m_flLastPull;
	CE_CSimpleSimTimer			m_StuckTimer;
