...
// Purpose: 
//-----------------------------------------------------------------------------
class CNPC_BaseScanner : public CNPCBaseInteractive<CAI_BasePhysicsFlyingBot>, public CDefaultPlayerPickupVPhysics
{
public:
	CE_DECLARE_CLASS( CNPC_BaseScanner, CNPCBaseInteractive<CAI_BasePhysicsFlyingBot> );
	CNPC_BaseScanner();
...
protected:
	...
	// Movement
	virtual bool		OverridePathMove( CEntity *pMoveTarget, float flInterval );
	...
	Vector				VelocityToEvade(CCombatCharacter *pEnemy);
...
private:
	...
	void TakeDamageFromPhyscannon( CPlayer *pPlayer );
