...
// The crow class.
//-----------------------------------------------------------------------------
class CNPC_Crow : public CE_Cycler_Fix
{

public:
	CE_DECLARE_CLASS( CNPC_Crow, CE_Cycler_Fix );
...
{
public:
	CE_DECLARE_CLASS( CNPC_Seagull, CNPC_Crow );
...
{
public:
	CE_DECLARE_CLASS( CNPC_Pigeon, CNPC_Crow );
